...
A library directory can hold the images and fonts that belong with it,
which `@image-url("@mylibrary/logo.png")` and `import "@mylibrary/MyFont.ttf";` reach the same way.
