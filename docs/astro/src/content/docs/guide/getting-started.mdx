...
Slint needs Rust 1.95 or newer; check with `rustc --version`.
...
- [Rust](https://www.rust-lang.org/learn/get-started), 1.95 or newer, to build Slint from source.
...
- **iOS:** see [adding iOS support](/guide/platforms/mobile/ios/#adding-ios-support-to-an-existing-application) for Rust or C++.
