---
title: FlexboxLayout
description: Experimental FlexboxLayout element.
---
...
> **Note**: `FlexboxLayout` is experimental and subject to change.
> Tracking issue: [slint-ui/slint#66](https://github.com/slint-ui/slint/issues/66).
