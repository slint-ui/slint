...
| i.MX8 w/ GPU  | `ghcr.io/slint-ui/slint/torizon-demos-arm64-imx8:latest`  |
| AM62 w/  GPU  | `ghcr.io/slint-ui/slint/torizon-demos-arm64-am62:latest`  |
| i.MX95 W/ GPU | `ghcr.io/slint-ui/slint/torizon-demos-arm64-imx95:latest` |
:::
