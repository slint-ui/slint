...
The current used decimal separator can be read with [decimal-separator](/reference/global-namespaces/platform#decimal-separator). As default the dot `.` is used as decimal separator.
