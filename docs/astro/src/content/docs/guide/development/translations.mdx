...
The current used decimal separator can be read with [decimal-separator](../../references/global-namespaces/platform.mdx#decimal-separator). As default the dot `.` is used as decimal separator.
