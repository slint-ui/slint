...
The decimal separatur currently used for localized float to string and vice versa conversions
For more information about localization and how to change the decimal separator see [translations page](/src/content/docs/guide/development/translations#selecting-the-decimal-separator)
</SlintProperty>
