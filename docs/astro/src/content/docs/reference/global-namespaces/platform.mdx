...
For more information about localization and how to change the decimal separator see [translations page](/guide/development/translations#selecting-the-decimal-separator)
</SlintProperty>
