...
### decimal-seperator
<SlintProperty propName="decimal-seperator" typeName="string" defaultValue="known at runtime">
The decimal separatur currently used for localized float to string and vice versa conversions
For more information about localization and how to change the decimal seperator see <Link type="translations" label="translations page"/>.
</SlintProperty>
