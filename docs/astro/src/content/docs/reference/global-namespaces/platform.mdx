...
### decimal-separator
<SlintProperty propName="decimal-separator" typeName="string" defaultValue="known at runtime">
The decimal separatur currently used for localized float to string and vice versa conversions when 
using `InputType.decimal-localized` property for the `TextInput`.
For more information about localization and how to change the decimal separator see [translations page](./../../guide/development/translations.mdx#selecting-the-decimal-separator)
</SlintProperty>
