...
### handle-swipe-left
<SlintProperty propName="handle-swipe-left" typeName="bool"/>

### handle-swipe-right
<SlintProperty propName="handle-swipe-right" typeName="bool"/>

### handle-swipe-up
<SlintProperty propName="handle-swipe-up" typeName="bool"/>

### handle-swipe-down
<SlintProperty propName="handle-swipe-down" typeName="bool"/>
