...
```slint
export component StringContains {
    property<bool> res1: "Hello".contains("ll"); // true
    property<bool> res2: "你好".contains("们"); // false
}
```
...
```slint
export component StringIsAscii {
    property<bool> res1: "Hello".is-ascii(); // true
    property<bool> res2: "你好".is-ascii(); // false
}
```
...
```slint
export component StringRepeat {
    property<string> res1: "Hello".repeat(3); // "HelloHelloHello"
    property<string> res2: "你好".repeat(2); // "你好你好"
}
```
...
```slint
export component StringReplace {
    property<string> res1: "Hello, World!".replace("World", "Slint"); // "Hello, Slint!"
    property<string> res2: "你好".replace("你", "大家"); // "大家好"
}
```
