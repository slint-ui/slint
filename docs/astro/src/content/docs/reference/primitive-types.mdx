...
export component StringRepeat {
    property<bool> res1: "Hello".repeat(3); // "HelloHelloHello"
    property<bool> res2: "你好".repeat(2); // "你好你好"
}
```
...
export component StringReplace {
    property<bool> res1: "Hello, World!".replace("World", "Slint"); // "Hello, Slint!"
    property<bool> res2: "你好".replace("你"，"大家"); // "大家好"
}
```
