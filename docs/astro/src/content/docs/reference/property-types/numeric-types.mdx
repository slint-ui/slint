---
title: Numeric Types
description: The numeric and unit types of the Slint language.
---
...
See [Converting Between Numbers and Strings](../type-conversions/#converting-between-numbers-and-strings).
