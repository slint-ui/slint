...
A property reference reads a property.
...
<OnlyInSC>
A name without an element reference refers to a property of the root element. \{#sls.expr.ref.unqualified}
</OnlyInSC>
</SC>

A name without an element reference follows the [lookup rules](../name-resolution/#lookup-rules):
...
A property reference evaluates to the value of the referenced property,
