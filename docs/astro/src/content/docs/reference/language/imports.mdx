...
the remainder of the path is resolved against the [component libraries](../../../guide/language/coding/file/#component-libraries) configured in the build system.
...
The first match in this search order is used.
To set the include paths for your build and your editor at once, use `include-paths` in a [project file](../../../guide/tooling/project-file/).
