...
A binding assigns an expression to a [property](../properties/) of the element in whose body it appears.
...
<NotInSC>
The full Slint language has further expression forms;
this specification doesn't cover them yet.
</NotInSC>
