...
A callback that fires when a link in the text is clicked. The parameter contains the clicked link as a string.
</SlintProperty>
...
By default, `StyledText` elements have the following accessibility properties set:
