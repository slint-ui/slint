...
<CodeSnippetMD imagePath="/src/assets/generated/rectangle-3.png" imageAlt="rectangle border-color" imageWidth="200" imageHeight="200">
```slint
Rectangle {
    width: 200px;
    height: 200px;
...
<CodeSnippetMD imagePath="/src/assets/generated/rectangle-4.png" imageAlt="rectangle border-width" imageWidth="200" imageHeight="200">
```slint
Rectangle {
    width: 200px;
    height: 200px;
...
<CodeSnippetMD imagePath="/src/assets/generated/rectangle-5.png" imageAlt="rectangle clip" imageWidth="200" imageHeight="400" skip="true">
```slint
...
<CodeSnippetMD imagePath="/src/assets/generated/rectangle-5.png" imageAlt="rectangle clip" imageWidth="200" imageHeight="400" noScreenShot>
```slint
// clip: false; the default
Rectangle {
    x: 50px; y: 50px;
...
<SlintProperty propName="border-bottom-right-radius" typeName="length"/>
