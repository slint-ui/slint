...
The font family of the selected value and of the values in the drop down list.
</SlintProperty>

### font-italic
<SlintProperty propName="font-italic" typeName="bool" defaultValue="false">
The italic state of the font of the selected value and of the values in the drop down list.
</SlintProperty>
