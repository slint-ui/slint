...
This section uses the standard rust tool `wasm-bindgen` and `wasm-pack` to run the game in the browser.
Read the [wasm-bindgen documentation](https://wasm-bindgen.github.io/wasm-bindgen/examples/without-a-bundler.html)
