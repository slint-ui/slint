---
title: Generic MCU Environment Setup
description: Generic instructions to cross-compile and use Slint on microcontrollers that don't have an out-of-the-box integration.
---
