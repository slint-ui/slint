...
This documentation is divided into three sub-sections:
  ...
  - [ESP-IDF section](/mcu/esp-idf/), when targeting MCUs with Espressif's IoT Development Framework
  - [STM32 section](/mcu/stm32/), when targeting MCUs in STMicroelectronics' STM32Cube Ecosystem.
  - [Generic section](/mcu/generic/), providing an overview how to use Slint with other MCUs.
