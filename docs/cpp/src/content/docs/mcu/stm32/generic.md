---
title: Generic Instructions for Slint on STM32 MCUs
description: A general path to get started with Slint on an STM32 MCU using STM32CubeMX when no ready-made template exists.
---
