...
data model, that is used with [`for` - `in`](https://slint.dev/docs/slint/guide/language/coding/repetition-and-data-models/)
repetitions or [`ListView`](https://slint.dev/docs/slint/reference/std-widgets/views/listview/) elements in the
...
It's possible to declare [singletons that are globally available](https://slint.dev/docs/slint/guide/language/coding/globals/)
