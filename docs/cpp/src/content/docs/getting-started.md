...
description: Use Slint in a CMake target — associate .slint files with slint_target_sources, link Slint::Slint, and show a window from C++.
---
...
then you can use the following code in your `main` function to show the [`Window`](https://slint.dev/docs/slint/reference/window/window/)
and change the text:
...
For an in-depth walk-through, read our [Slint Memory Game Tutorial](https://slint.dev/docs/slint/tutorial/quickstart/).
