...
For the licenses of all dependencies bundled with the `slint` package, see the
separate <a href={pythonDocsPublicAsset("thirdparty/")}>Third-Party Licenses page</a>.
