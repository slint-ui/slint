...
![Command palette](/src//assets/getting-started/macos-vscode-template-1.webp)

4. **Choose your language.**
![Command palette](/src/assets/getting-started/macos-vscode-template-3.webp)

5. **Choose a folder to save the project in.**  
![Project folder](/src/assets/getting-started/macos-vscode-template-2.webp)
