...
<CodeSnippetMD imagePath="/src/assets/generated/image-example.png"  imageWidth="200" imageHeight="100"  imageAlt='image example'>
```slint title="test-example.slint" preview
