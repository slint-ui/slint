...
<CodeSnippetMD imagePath="/src/assets/generated/test1.png" imageAlt='Colored text'>
```slint "color: red;"
Text {
    text: "Hello";
    color: red;
...
<CodeSnippetMD imagePath="/src/assets/generated/test2.png" imageAlt='font-family'>
...
<CodeSnippetMD imagePath="/src/assets/generated/test2.png" imageWidth="100" imageHeight="100" imageAlt='font-family'>
