...
import col_img from '../../../assets/slint-logo-square-dark.webp'
import col_snippet from '../../snippets/elements/text/color.slint?raw'

<CodeSnippet 
    codeContent={col_snippet} 
    lines={[2, 5]}
    meta="{3}"
    removeSpaces={4} 
    codeLang='slint' 
    imageSrc={col_img}
    imageAlt='Colored text'
/>
</SlintProperty>
