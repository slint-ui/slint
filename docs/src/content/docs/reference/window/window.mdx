...
### skip-taskbar
<SlintProperty propName="skip-taskbar" typeName="bool" defaultValue="false">
Whether to show or hide the window icon in the taskbar. This is feature only supported on Windows.
</SlintProperty>
