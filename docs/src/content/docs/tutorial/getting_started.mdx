...
import initialCpp from '../../collections/code/main_initial.cpp?raw'

<Code code={initialCpp} lang="cpp" title="main_initial.cpp" />
...
import appWindow from '../../collections/code/app-window.slint?raw'

<Code code={appWindow} lang="slint" title="app-window.slint" />
...
import mainInitialJs from '../../collections/code/main_initial.js?raw'

<Code code={mainInitialJs} lang="js" title="main_initial.js" />
...
import memorySlint from '../../collections/code/memory.slint?raw'

<Code code={memorySlint} lang="slint" title="memory.slint" />
