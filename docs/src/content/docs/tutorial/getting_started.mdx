...
import initialCpp from '../../code/main_initial.cpp?raw'
...
import appWindow from '../../code/app-window.slint?raw'
...
import mainInitialJs from '../../code/main_initial.js?raw'
...
import memorySlint from '../../code/memory.slint?raw'
