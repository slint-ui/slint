...
import gameLogicInRust from '../../code/main_game_logic_in_rust.rs?raw'
...
import gameLogicInCpp from '../../code/main_game_logic.cpp?raw'
...
import gameLogicInJs from '../../code/main_game_logic.js?raw'
