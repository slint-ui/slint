...
We recommend setting up a git pre-commit hook to automatically run autofix tasks (formatting, linting) before committing. See [Git Hooks Setup](git_hooks.md) for details.
