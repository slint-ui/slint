...
[property declared](/reference/language/properties/#sls.prop.decl.form) on the
...
The image of an [`@image-url()`](/reference/language/expressions/#sls.expr.image.form)
...
The application reacts to the [callbacks declared](/reference/language/callbacks/#sls.callback.decl.form) on the root
...
Each [struct](/reference/language/structs-and-enums/#sls.struct.decl) or
[enum](/reference/language/structs-and-enums/#sls.enum.decl) declared in the `.slint` file
