...
| `slint.runtime.err.frame-overrun` | A frame takes longer to render than the display refresh interval. | The display freezes on old content, which looks like a working instrument. | `slint.runtime.cstr.frame-time` | No |
