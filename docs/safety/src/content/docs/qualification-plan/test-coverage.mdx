...
which elements were drawn, which bindings were evaluated, and which outcomes of every `?:`, `&&` and `||` were taken.
[Coverage of Slint Code](/qualification-plan/slint-coverage/) describes the measurement and how the tool that takes it is tested.
