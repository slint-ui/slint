...
* ISO 26262-4 8.x: Safety validation is at the vehicle level, so it belongs to the integrator. See [User Responsibility](/user-manual/#user-responsibility). Our own verification is in [Verification](/qualification-plan/verification/).
