...
function createReferenceExpression(
    ...
    let targetColumnName = targetModes.find(
        (mode) =>
    ...
    if (!targetColumnName) {
        targetColumnName = targetModes.find(
            (mode) => mode === sourceColumnName,
        );
    }
    ...
    if (!targetColumnName) {
        ...
        console.log(
            `Using default mode ${targetColumnName} for reference to ${referenceId}`,
        );
    }
                    ...
                    if (data.refId) {
                        ...
                        if (valueExpression.includes("global_size-&-spacing")) {
                            valueExpression = valueExpression.replace(
                                /global_size-&-spacing/g,
                                "global_size-and-spacing",
                            );
                        }
