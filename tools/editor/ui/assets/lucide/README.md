...
These icons come from Lucide revision `22e6094bb533ac2b0ae3b592d2184da461ec1f4b`:

- [file-plus.svg](https://github.com/lucide-icons/lucide/blob/22e6094bb533ac2b0ae3b592d2184da461ec1f4b/icons/file-plus.svg)
...
Each SVG changes only `stroke-width` from `2` to `1.6` to match the editor's icon weight.
Preserve this change when updating the files.
...
It does not list `file-plus`, `image`, `panels-top-left`, or `pointer` as Feather-derived.
