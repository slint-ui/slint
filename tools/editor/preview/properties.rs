...
use i_slint_editor_preview::Result;
...
pub struct QueryPropertyResponse {
    pub element_rc_node: i_slint_editor_preview::ElementRcNode,
...
fn find_block_range(element: &i_slint_editor_preview::ElementRcNode) -> Option<TextRange> {
...
fn get_element_information(element: &i_slint_editor_preview::ElementRcNode) -> ElementInformation {
...
fn create_text_document_edit_for_set_binding_on_existing_property(
    ...
    property.defined_at.as_ref().map(|defined_at| {
        ...
        i_slint_editor_preview::editing::create_text_document_edit(uri, version, vec![edit])
    })
}
...
pub fn set_bindings(
    ...
    version: SourceFileVersion,
    element: &i_slint_editor_preview::ElementRcNode,
    properties: &[i_slint_editor_preview::editing::PropertyChange],
    format: i_slint_editor_preview::ByteFormat,
) -> Option<lsp_types::WorkspaceEdit> {
...
) -> Result<i_slint_editor_preview::ElementRcNode> {
...
pub fn update_element_properties(
    document_cache: &i_slint_editor_preview::DocumentCache,
    position: i_slint_editor_preview::editing::VersionedPosition,
    properties: Vec<i_slint_editor_preview::editing::PropertyChange>,
) -> Option<lsp_types::WorkspaceEdit> {
...
pub mod tests {
    ...
    use i_slint_editor_preview::test::{complex_document_cache, loaded_document_cache};
    ...
    pub fn properties_at_position_in_cache(
        ...
        document_cache: &i_slint_editor_preview::DocumentCache,
        url: &lsp_types::Url,
    ) -> Option<(i_slint_editor_preview::ElementRcNode, Vec<PropertyInformation>)> {
        let element =
    ...
    fn properties_at_position(
        ...
        i_slint_editor_preview::ElementRcNode,
        Vec<PropertyInformation>,
        i_slint_editor_preview::DocumentCache,
        lsp_types::Url,
    )> {
