...
Slint is available under a [royalty-free license](LICENSES/LicenseRef-Slint-Community.md) or [GNU GPLv3](LICENSES/GPL-3.0-only.txt), at your choice. For paid plans, visit our website [https://slint.dev](https://slint.dev) or contact us at [info@slint.dev](mailto:info@slint.dev).
