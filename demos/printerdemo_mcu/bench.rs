...
use slint::platform::software_renderer::{
    MinimalSoftwareWindow, Rgb565Pixel, Rgb565PixelBE, TargetPixel,
};
...
#[divan::bench(
    types = [Rgb565Pixel, Rgb565PixelBE, slint::Rgb8Pixel],
...
#[divan::bench(types = [Rgb565Pixel, Rgb565PixelBE, slint::Rgb8Pixel])]
