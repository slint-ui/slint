...
impl Default for StmBackend {
    fn default() -> Self {
        ...
        // Magic to configure the MPU to allow for code execution in the SDRAM; taken from stm32h7xx-hal repo
        {
            ...
            const REGION_BASE_ADDRESS: u32 = 0x7000_0000;

            const REGION_FULL_ACCESS: u32 = 0x03;
            const REGION_CACHEABLE: u32 = 0x01;
            const REGION_WRITE_BACK: u32 = 0x00;
