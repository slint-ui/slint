...
function(SLINT_TARGET_SOURCES target)
    ...
    foreach (it IN ITEMS ${SLINT_TARGET_SOURCES_UNPARSED_ARGUMENTS})
        ...
        set(assets_section_target_prop "$<TARGET_PROPERTY:${target},SLINT_ASSETS_SECTION>")
        set(assets_section_arg "$<IF:$<STREQUAL:${assets_section_target_prop},>,,--assets-section=${assets_section_target_prop}>")
