...
without pre-built binaries, you need to additional software:
  ...
  * **[Rust compiler](https://www.rust-lang.org/tools/install)** (1.85 or newer) * Depending on your operating system, you may need additional components. For a list of required system libraries,
