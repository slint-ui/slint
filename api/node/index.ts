...
export abstract class Model<T> {
    ...
    map<U>(
        ...
        return new MapModel(this, mapFunction, mapBackFunction);
    }
 ...
 * ## Example
 *
 *  Here we have a {@link ArrayModel} holding rows of a custom interface `Name`.
 *
 * ```ts
...
* console.log(mappedModel.rowData(2));
*
* // Alternatively you can do it also on the MapModel
*
* const model = new ArrayModel<Name>([
*     {
*         first: "Hans",
...
* );
*
* mappedModel.setRowData(1, "Musterfrau, Minnie");
*
* // prints "Emil, Hans"
* console.log(mappedModel.rowData(0));
*
...
export class MapModel<T, U> extends Model<U> {
     ...
     * @param mapBackFunction maps the data back from U to T.
     */
    constructor(
        sourceModel: Model<T>,
        mapFunction: (data: T) => U,
