...
/// The header every generated module starts with.
fn generated_header(sources: &[&str]) -> String {
    let mut out = String::from("// Copyright © SixtyFPS GmbH <info@slint.dev>\n");
    ...
    out.push_str("// AUTO-GENERATED by api/node/build.rs from ");
