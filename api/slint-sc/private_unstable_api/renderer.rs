...
pub fn fill_rect(
    ...
    let x0 = position[0].clamp(0, buffer_size.width as i32) as usize;
    let x1 = position[0].saturating_add(size[0]).clamp(0, buffer_size.width as i32) as usize;
    let y0 = position[1].clamp(0, buffer_size.height as i32) as usize;
    let y1 = position[1].saturating_add(size[1]).clamp(0, buffer_size.height as i32) as usize;
