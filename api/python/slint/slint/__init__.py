...
def _load_file_checked(
    ...
    expected_api = gzip.decompress(base64.standard_b64decode(expected_api_base64_compressed)).decode("utf-8")
    ...
    generated_api_module.compare_generated_vs_actual(generated=generated_api_module, actual=actual_api_module)
