...
class ComponentDefinition:
    ...
    def property_infos(self) -> list[PropertyInfo]: ...
    def callback_infos(self) -> list[CallbackInfo]: ...
    def function_infos(self) -> list[FunctionInfo]: ...
    def global_property_infos(self, global_name: str) -> list[PropertyInfo]: ...
    def global_callback_infos(self, global_name: str) -> list[CallbackInfo]: ...
    def global_function_infos(self, global_name: str) -> list[FunctionInfo]: ...
