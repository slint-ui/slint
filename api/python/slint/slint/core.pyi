...
class Color:
    ...
    def alpha(self) -> builtins.int:
        ...
        The alpha channel.
        """
    def __new__(cls, maybe_value: typing.Optional[builtins.str | PyColorInput.RgbaColor | PyColorInput.RgbColor] = None) -> Self: ...
...
class ComponentDefinition:
    ...
    def global_properties(self, name: builtins.str) -> typing.Optional[builtins.dict[builtins.str, ValueType]]: ...
    def global_callbacks(self, name: builtins.str) -> typing.Optional[builtins.list[builtins.str]]: ...
    def global_functions(self, name: builtins.str) -> typing.Optional[builtins.list[builtins.str]]: ...
