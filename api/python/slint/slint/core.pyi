...
class ComponentDefinition:
    ...
    ) -> builtins.dict[builtins.str, ValueType]: ...
...
class MenuEntry:
    ...
    def __init__(
        ...
        *,
        ...
        checked: typing.Any = ...,
        has_sub_menu: typing.Any = ...,
        is_separator: typing.Any = ...,
    ) -> None: ...
...
class StateInfo:
    ...
    def __init__(
        self, *, current_state: typing.Any = ..., previous_state: typing.Any = ...
    ) -> None: ...
