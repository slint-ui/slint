...
class PyModelAdapter:
    @staticmethod
    def map(
        source: typing.Any,
        map_function: typing.Callable[[typing.Any], typing.Any],
        target: PyModelBase,
    ) -> PyModelAdapter: ...
    @staticmethod
    ...
    def row_data(self, row: int) -> typing.Any: ...
    def set_row_data(self, row: int, data: typing.Any) -> None: ...
    def reset(self) -> None: ...
