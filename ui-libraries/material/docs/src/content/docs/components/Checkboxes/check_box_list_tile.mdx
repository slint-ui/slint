...
description: CheckBoxListTile API.
---

import CodeSnippetMD from '/src/components/CodeSnippetMD.astro';
import SlintProperty from '/src/components/SlintProperty.astro';

<CodeSnippetMD imagePath="/src/assets/generated/checkboxlisttile.png" scale="3" imageWidth="140" imageHeight="100" imageAlt="">
```slint
import { CheckBoxListTile, CheckState } from "./material.slint";
...
A `CheckBoxListTile` is a control that combines a text label with a `CheckBox`. See [CheckBox](/components/checkboxes/check_box/) and [ListTile](/components/list_tile/) for more information.
