...
The index of the currently selected tab. This is a 0-based index that includes only
visible tabs. If tabs are dynamically allocated or are conditionally hidden, then
they will be ignored for counting the value of `current-index`.
</SlintProperty>
