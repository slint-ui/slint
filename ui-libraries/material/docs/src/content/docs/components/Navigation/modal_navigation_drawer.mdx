...
description: ModalNavigationDrawer API.
---

import CodeSnippetMD from '/src/components/CodeSnippetMD.astro';
import SlintProperty from '/src/components/SlintProperty.astro';

<CodeSnippetMD imagePath="/src/assets/generated/modalnavigationdrawer.png" scale="3" imageWidth="300" imageHeight="200" imageAlt="">
```slint
import { ModalNavigationDrawer, FilledButton } from "./material.slint";
