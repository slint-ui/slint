...
use crate::component_catalog::ComponentInformation;
...
fn fuzzy_filter_iter<Item: std::fmt::Debug>(
    ...
    all_matches.sort_by_key(|match_| std::cmp::Reverse(match_.0));
...
pub fn ui_set_known_components(
    api: &Api<'_>,
    known_components: &[crate::component_catalog::ComponentInformation],
