...
/// snaps. Numbers interpolate in `f32`, matching the generated code where
/// animated numeric properties are `f32`-based — an `f64` blend would leak
/// rounding noise like `99.50000001117587` where codegen yields `99.5`.
