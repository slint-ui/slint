...
#[pin]
pub struct SystemTrayListItem {
    pub cached_rendering_data: CachedRenderingData,
    pub label: Property<SharedString>,
    pub enabled: Property<bool>,
    pub activated: Callback<VoidArg>,
}

impl Item for SystemTrayListItem {
    fn init(self: Pin<&Self>, _self_rc: &ItemRc) {}
...
impl ItemConsts for SystemTrayListItem {
    const cached_rendering_data_offset: const_field_offset::FieldOffset<
        SystemTrayListItem,
        CachedRenderingData,
    > = SystemTrayListItem::FIELD_OFFSETS.cached_rendering_data().as_unpinned_projection();
}
