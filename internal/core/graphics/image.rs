...
impl Image {
    ...
    pub fn to_wgpu_27_texture(&self) -> Option<wgpu::Texture> {
        match &self.0 {
            ImageInner::WGPUTexture(WGPUTexture::WGPUTexture(texture)) => Some(texture.clone()),
            _ => None,
        }
    }
    ...
    pub fn to_wgpu_29_texture(&self) -> Option<wgpu::Texture> {
        match &self.0 {
            ImageInner::WGPUTexture(WGPUTexture::WGPUTexture(texture)) => Some(texture.clone()),
            _ => None,
        }
