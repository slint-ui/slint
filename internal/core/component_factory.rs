...
/// properties of the Slint language.
///
/// The `component-factory` is used by an `Embed` element in the Slint UI to
/// embed UI elements based on the produced component below the `Embed` element.
