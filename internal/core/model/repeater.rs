...
impl<C: RepeatedItemTree + 'static> Repeater<C> {
    ...
    /// When the repeated element has a dynamic z binding, the instances are visited
    ...
    /// z-ordered traversal), or all the instances when it is `u32::MAX`.
    pub fn visit_maybe_instance(
        ...
        if instance == u32::MAX {
            ...
            self.visit_instance(instance, order, visitor)
        }
    }
