...
pub struct TestingWindow {
    ...
    mouse_cursor: RefCell<i_slint_core::items::MouseCursorInner>,
...
impl TestingWindow {
    ...
    pub fn mouse_cursor(&self) -> i_slint_core::items::MouseCursorInner {
...
impl WindowAdapterInternal for TestingWindow {
    ...
    fn set_mouse_cursor(&self, cursor: i_slint_core::items::MouseCursorInner) {
