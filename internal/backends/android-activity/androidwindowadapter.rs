...
impl AndroidWindowAdapter {
    pub fn new(app: AndroidApp) -> Rc<Self> {
        ...
        Rc::<Self>::new_cyclic(|w| Self {
            ...
            #[cfg(not(any(feature = "unstable-wgpu-26", feature = "unstable-wgpu-27", feature = "unstable-wgpu-28")))]
            ...
            #[cfg(all(feature = "unstable-wgpu-26", not(feature = "unstable-wgpu-27"), not(feature = "unstable-wgpu-28")))]
