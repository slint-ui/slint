...
pub const QAccessible_Event_StandardTableRowDescriptionChanged: QAccessible_Event = 279;
pub const QAccessible_Event_StandardTableRowHeaderChanged: QAccessible_Event = 280;
