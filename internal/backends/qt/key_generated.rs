...
pub const Qt_Key_Key_micro: Qt_Key = 181;
...
pub const Qt_ScrollPhase_ScrollEnd: Qt_ScrollPhase = 3;
pub const Qt_ScrollPhase_ScrollMomentum: Qt_ScrollPhase = 4;
pub type Qt_ScrollPhase = ::std::os::raw::c_uint;
