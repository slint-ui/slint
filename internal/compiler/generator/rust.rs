    ...
    quote!(
        ...
        impl #inner_component_id {
            pub fn new(#(parent: #parent_component_type)*) -> #new_result {
                ...
                let _self = self_rc.as_pin_ref();
                let self_dyn_weak = vtable::VWeak::into_dyn(vtable::VRc::downgrade(&self_rc));
                sp::register_component(_self, &self_dyn_weak, Self::item_array(), (*#root_token).maybe_window_adapter());
