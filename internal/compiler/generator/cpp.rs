    ...
    match function {
        ...
        BuiltinFunction::SetFocusItem => {
            if let [llr::Expression::PropertyReference(pr)] = arguments {
                ...
                format!("{window}.set_focus_item({focus_item}, true, slint::cbindgen_private::FocusReason::BuiltinFunction);")
            } else {
        ...
        BuiltinFunction::ClearFocusItem => {
            if let [llr::Expression::PropertyReference(pr)] = arguments {
                let window = access_window_field(ctx);
                let focus_item = access_item_rc(pr, ctx);
                format!("{window}.set_focus_item({focus_item}, false, slint::cbindgen_private::FocusReason::BuiltinFunction);")
            } else {
