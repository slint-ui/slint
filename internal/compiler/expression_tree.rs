...
pub enum Expression {
    ...
    /// Strided cache access (grid layouts with repeated rows, see docs/development/layout-system.md).
    GridRowCacheAccess {
        /// This property holds an array of entries
        layout_cache_prop: NamedReference,
        /// The index into that array (position of jump cell: `cache[index] = data_base`).
        index: usize,
...
impl Expression {
    ...
    pub fn ty(&self) -> Type {
        match self {
            ...
            Expression::GridRowCacheAccess { .. } => Type::LogicalLength,
    ...
    pub fn is_constant(&self, ga: Option<&crate::passes::GlobalAnalysis>) -> bool {
        match self {
            ...
            Expression::GridRowCacheAccess { .. } => false,
