...
declare_builtin_function_types!(
    ...
    UpdateAnimations: () -> Type::Void,
    StartAnimation: (Type::ElementReference) -> Type::Void,
    StopAnimation: (Type::ElementReference) -> Type::Void,
    RestartAnimation: (Type::ElementReference) -> Type::Void,
...
impl BuiltinFunction {
    ...
    fn is_const(&self, global_analysis: Option<&crate::passes::GlobalAnalysis>) -> bool {
        match self {
            ...
            BuiltinFunction::UpdateAnimations => false,
            BuiltinFunction::StartAnimation => false,
            BuiltinFunction::StopAnimation => false,
            BuiltinFunction::RestartAnimation => false,
