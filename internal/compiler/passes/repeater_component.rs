    ...
    recurse_elem(&component.root_element, &(), &mut |original_elem_rc, _| {
        ...
        let repeated_component = Rc::new(Component {
            root_element: Rc::new(RefCell::new(Element {
                ...
                has_dynamic_z_order: original_elem.has_dynamic_z_order,
                dynamic_z_child_refs: std::mem::take(&mut original_elem.dynamic_z_child_refs),
                dynamic_z_child_constants: std::mem::take(
                    &mut original_elem.dynamic_z_child_constants,
                ),
