...
impl super::Surface for WGPUSurface {
    ...
    fn import_wgpu_texture(
        ...
        let texture = match any_wgpu_texture {
            i_slint_core::graphics::WGPUTexture::WGPUTexture(texture) => texture.clone(),
        };
