...
#[cfg(all(feature = "vulkan", not(skia_wgpu_vulkan)))]
compile_error!(
    "renderer-skia-vulkan feature was specified, but slint does not support Vulkan on the target platform"
);
...
#[cfg(all(skia_wgpu_vulkan, skia_backend_wgpu))]
