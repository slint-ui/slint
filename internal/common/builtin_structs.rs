    ...
    ($macro:ident) => {
        $macro![
            ...
            struct KeyboardModifiers {
                @name = NativeType::Private(NativePrivateType::KeyboardModifiers),
                export {
            ...
            struct PointerEvent {
                @name = NativeType::Private(NativePrivateType::PointerEvent),
                export {
            ...
            struct PointerScrollEvent {
                @name = NativeType::Private(NativePrivateType::PointerScrollEvent),
                export {
            ...
            struct KeyEvent {
                @name = NativeType::Private(NativePrivateType::KeyEvent),
                export {
            ...
            struct DropEvent {
                @name = NativeType::Private(NativePrivateType::DropEvent),
                export {
            ...
            struct StandardListViewItem {
                @name = NativeType::Public(NativePublicType::StandardListViewItem),
                export {
            ...
            #[non_exhaustive]
            struct TableColumn {
                @name = NativeType::Private(NativePrivateType::TableColumn),
                export {
            ...
            struct StateInfo {
                @name = NativeType::Private(NativePrivateType::StateInfo),
                export {
            ...
            struct FontMetrics {
                @name = NativeType::Private(NativePrivateType::FontMetrics),
                export {
            ...
            struct MenuEntry {
                @name = NativeType::Private(NativePrivateType::MenuEntry),
                export {
