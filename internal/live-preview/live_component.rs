...
mod ffi {
    ...
    pub extern "C" fn slint_live_preview_new(
        ...
        translation_bundle_path: Slice<u8>,
        ...
        if !translation_bundle_path.is_empty() {
            compiler.set_translation_bundle_path(
                std::str::from_utf8(&translation_bundle_path).unwrap().into(),
            );
        }
        Rc::into_raw(
