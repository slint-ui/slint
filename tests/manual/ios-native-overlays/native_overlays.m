...
@interface SlintTextClipView : UIView
@end
           ...
           secondInitialText:(NSString *)secondInitialText
{
    ...
    self.secondEditor =
            [[SlintTextInputView alloc] initWithFrame:secondEditorFrameInClip
                                                 host:host
...
- (void)updateSecondEditorFrame:(CGRect)secondEditorFrame
{
    ...
    [self.secondEditor layoutIfNeeded];
}
...
- (void)hostTapped:(UITapGestureRecognizer *)recognizer
{
    ...
    } else if (CGRectContainsPoint(secondEditorFrame, point)) {
        [self.editor resignFirstResponder];
        [self.nativeEditor resignFirstResponder];
        [self.secondEditor becomeFirstResponder];
    } else if (CGRectContainsPoint(self.secondEditorClip.frame, point)) {
        return;
