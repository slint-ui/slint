...
static LICENSE_LOCATION_FOR_FILE: LazyLock<Vec<(regex::Regex, LicenseLocation)>> =
    LazyLock::new(|| {
        [
            ...
            ("\\.c$", LicenseLocation::Tag(LicenseTagStyle::cpp_style_comment_style())),
            ...
            ("\\.modulemap$", LicenseLocation::Tag(LicenseTagStyle::cpp_style_comment_style())),
            ...
            ("\\.swift$", LicenseLocation::Tag(LicenseTagStyle::cpp_style_comment_style())),
