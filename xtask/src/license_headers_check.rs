...
static LICENSE_LOCATION_FOR_FILE: LazyLock<Vec<(regex::Regex, LicenseLocation)>> =
    LazyLock::new(|| {
        [
            ...
            ("\\.bb$", LicenseLocation::Tag(LicenseTagStyle::shell_comment_style())),
            ("\\.bbappend$", LicenseLocation::Tag(LicenseTagStyle::shell_comment_style())),
            ("\\.inc$", LicenseLocation::Tag(LicenseTagStyle::shell_comment_style())),
